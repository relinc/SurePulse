...
//		5.0	4.5
		...
		assertTrue(Arrays.equals(force.getModifiedData(), new double[]{5.0,6.8,8.6,11.2,9.0}));
		assertTrue(Arrays.equals(force.getModifiedTime(), new double[]{1,2,3,4,5}));
	...
	public void testForceDataset(){
		...
		assertTrue(Arrays.equals(force.getModifiedData(), data));
		assertTrue(Arrays.equals(force.getModifiedTime(), time));
