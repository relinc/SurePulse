	...
	public void testDatatypes(){
		...
		for(dataType type : types){ //Tests all the data types.
			...
			if(type == dataType.INCIDENTSG || type == dataType.INCIDENTBARSTRAIN){
				...
				assertArrayEquals(new double[]{1.1/2, 2.1/2, 3.2/2, 4.5/2}, extractedData.get(0).Data.getData(), 0);
				assertArrayEquals(new double[]{1.1/2, 2.1/2, 3.2/2, 4.5/2}, extractedData.get(1).Data.getData(), 0);
			}
			else{
